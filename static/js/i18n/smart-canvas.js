(function(){
    ...
    window.StudioI18n.register({
        ...
        "smart.videoModelManual": { zh: "手动模型 ID", en: "Manual model ID" },
        "smart.videoModelManualPlaceholder": { zh: "输入模型标识", en: "Enter model ID" },
        "smart.videoModelManualHint": { zh: "该平台未提供模型列表，请填写实际模型标识", en: "This provider has no catalog; enter the model id supported by it." },
        ...
        "smart.shortcutRedoAlias": { zh: "恢复上一步操作（另一种快捷键）", en: "Redo the last action (alternate shortcut)" },
