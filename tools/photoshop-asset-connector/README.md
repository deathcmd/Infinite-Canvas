# Canvas Lab 资产桥 · Photoshop 插件

一个 Adobe Photoshop UXP 面板插件，通过局域网地址连接 Canvas Lab 后端，双向打通 PS 与本地资产库：
...
2. 在 Photoshop 里打开「Canvas Lab 资产桥」面板。
3. 顶部填入服务地址：
...
4. 点 `Load`，在 PS 的「增效工具」菜单里打开「Canvas Lab 资产桥」。
